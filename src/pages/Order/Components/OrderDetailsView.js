...
const OrderDetailsView = ({ loading, singleOrder, totalAmount, setStateUpdated }) => {
   ...
   return (
      <section className={styles.order_details_page_wrapper}>
         ...
         <div className={darkMood ? `${styles.product_details_wrapper} ${"dark_mood_secondary"}` : `${styles.product_details_wrapper} ${"light_mood_secondary"}`}>
            {loading &&
         ...
         <div className={styles.shipping_and_amount_wrapper}>
            <div className={darkMood ? `${styles.shipping_wrapper} ${"dark_mood_secondary"}` : `${styles.shipping_wrapper} ${"light_mood_secondary"}`}>
            ...
            <div className={darkMood ? `${styles.amount_wrapper} ${"dark_mood_secondary"}` : `${styles.amount_wrapper} ${"light_mood_secondary"}`}>
               <div className={styles.border_bottom}>
                  <Typography
                     variant={"widgetTitle"}
                     color={darkMood ? "paragraph" : "primary"}>
               ...
               <div className={styles.amount_summery_top}>
                  <Typography
                     color={darkMood ? "paragraph" : "primary"} variant={"dataGridTitle"}>
                     <span>Sub Total:</span>
